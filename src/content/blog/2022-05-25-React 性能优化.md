---
title: "React 性能优化"
description: "避免不必要的组件更新。 将 props 设置为数组或对象 每次调用 React 组件都会创建新组件，就算传入的数组或对象的值没有改变，他们的引用地址也会发生改变，比如，如果按照如下的写法，那么每次渲染时 style 都是一个新对象 使用 PureComponent、React.m"
publishedAt: "2022-05-31"
tags:
  - "React 性能优化"
draft: false
featured: true
permalink: "/2022/05/31/React-性能优化/"
legacy: true
---
**避免不必要的组件更新。**
