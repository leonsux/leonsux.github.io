...
description: "函数中 this 的指向 & 箭头函数中 this 的指向 如果调用者函数，被某一个对象所拥有，那么该函数在调用时，内部的this指向该对象。如果函数独立调用，那么该函数内部的this，则指向undefined。但是在非严格模式中，当this指向undefined时，它会被自动指"
...
draft: false
featured: false
permalink: "/2022/05/09/this指向-&-apply与bind重写/"
legacy: true
---
