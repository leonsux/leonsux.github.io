---
title: "模块化"
description: "为什么要有模块化？ 项目庞大时，js文件多，变得不好维护 js文件作用域都是顶层，这会造成变量污染 js文件依赖问题，稍微不注意顺序引入错，代码全报错 CommonJS CommonJS 是一个更偏向于服务器端的规范。NodeJS 采用了这个规范。CommonJS 的一个模块就是"
publishedAt: "2022-06-14"
tags:
  - "模块化"
draft: false
featured: true
permalink: "/2022/06/14/模块化/"
legacy: true
---
为什么要有模块化？
