---
title: "老生常谈的JS闭包"
description: "闭包，虽然工作中用到的频率并不高，但是在面试中用到的频率倒不低，或许，闭包最大的一个功劳就是封装了jQuery吧 闭包 闭包是一个能读取其他函数内部变量的函数： 从这句话我们可以看出： 1. 闭包是一个函数 2. 这个函数能读取到其他函数内部的变量（局部变量） 3. 他能让读取到"
