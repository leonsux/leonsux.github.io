...
description: "JS中使用 name 作为变量名出现的问题 今天突然被问到一个问题：我定义了一个数组 var name = [\"leon\", \"jack\", \"tom\"]; ，但是为什么通过下标获取不到正确的值，而且居然能获取到 ,。当时我以为是什么细节问题，仔细检查了一下代码后发现并没有什么问"
publishedAt: "2016-11-27"
tags:
  - "Js"
draft: false
featured: false
permalink: "/2016/11/27/JS中以name作为变量名出现的问题-2017/"
legacy: true
---
