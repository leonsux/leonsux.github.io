---
title: "JS中的作用域问题"
description: "JS解析器解析步骤 第一步：寻找代码中定义的变量，函数，参数（预解析，这也是在声明变量前使用变量不报错的原因） 第二部：逐行解读代码 Tips 1. 定义在script中的变量，称为全局变量，函数则称为全局函数，当变量名与函数名一致时会保留函数 2. 当有多个script时，先解"
publishedAt: "2016-08-10"
tags:
  - "Js"
draft: false
featured: false
permalink: "/2016/08/10/JS中的作用域问题-2016/"
legacy: true
---
### JS解析器解析步骤
