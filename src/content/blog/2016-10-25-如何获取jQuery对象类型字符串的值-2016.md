...
description: "问题 标题可能有点绕，大致意思就是通过$()，把一个字符串str = \"hello\"转成了jQuery对象，如何获取到原字符串的值。为什么会有这种需求呢？因为今天封装一个处理字符串的jQuery方法时发现了这个问题。 方法里的this是jQuery对象，并没有原生的replace"
...
draft: false
featured: false
permalink: "/2016/07/16/如何获取jQuery对象类型字符串的值-2016/"
legacy: true
---
### 问题
