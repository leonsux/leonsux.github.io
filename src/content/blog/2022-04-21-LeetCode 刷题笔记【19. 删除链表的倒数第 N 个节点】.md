...
description: "题目 https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list/ 给你一个链表，删除链表的倒数第 n个结点，并且返回链表的头结点。 示例 输入： head = [1,2,3,4,5], n = 2 输出： "
...
draft: false
featured: false
permalink: "/2022/04/21/LeetCode-刷题笔记-19.-删除链表的倒数第-N-个节点/"
legacy: true
---
## 题目
